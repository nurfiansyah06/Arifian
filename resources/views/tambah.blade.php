...
@section('container')
	...
	<div class="container">
    <br><a href="{{url('/')}}" class="btn" style="border-radius:3px;background:greenyellow;color:white"><strong>Kembali Ke Beranda</strong></a>
	<form action="{{url('/siswa/store')}}" method="post">
		...
		<label>
		  ...
		  <input type="text" class="input" name="hp" required="required">
		  <div class="line-box">
			<div class="line"></div>
		  </div>
		</label>
